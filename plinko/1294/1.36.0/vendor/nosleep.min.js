...
var NoSleep = __webpack_require__(1);
...
function subscribe() {
    if (typeof Hacksaw !== 'undefined') {
        ...
        _casinoChannel.subscribe('initGame', function (data) {
            if (data.channel == 'mobile' && data.disabledNosleep != true) {
...
const { webm, mp4 } = __webpack_require__(2);
